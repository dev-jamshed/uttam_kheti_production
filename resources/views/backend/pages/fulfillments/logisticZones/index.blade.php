                        ...
                        <table class="table tt-footable border-top align-middle" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-breakpoints="xs sm">{{ localize('Areas') }}</th>
                            ...
                            <tbody>
                                @foreach ($logisticZones as $key => $logisticZone)
                                    <tr>
                                        ...
                                        <td>
                                            @foreach ($logisticZone->cities as $city)
                                                {{ $city->city->name }}@if (!$loop->last), @endif
                                            @endforeach
                                        </td>

                                        <td>
                                            @forelse ($logisticZone->areas as $logisticZoneArea)
                                                <span class="badge bg-secondary rounded-pill">{{ $logisticZoneArea->area->name }}</span>
                                            @empty
