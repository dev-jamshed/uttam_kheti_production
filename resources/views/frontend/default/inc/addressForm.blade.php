                    ...
                    <div class="row align-items-center g-4 mt-3">
                        <form action="{{ route('address.store') }}" method="POST">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-6">
                                    <div class="w-100 label-input-field">
                                        <label>{{ localize('Area') }}</label>
                                        <select class="select2Address" required name="area_id">
                            ...
                            <div class="mt-6 d-flex">
                                <button type="submit" class="btn btn-secondary btn-md me-3">{{ localize('Save') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <form action="{{ route('address.update') }}" method="POST">
                            ...
                            <div class="row g-4">
                                <div class="col-sm-6">
                                    <div class="w-100 label-input-field">
                                        <label>{{ localize('Country') }}</label>
                                        <select class="select2Address" name="country_id" id="edit_country_id" required>
                                            <option value="">{{ localize('Select Country') }}</option>
                                            @foreach ($countries as $country)
                                                <option value="{{ $country->id }}">{{ $country->name }}</option>
                                            @endforeach
                                ...
                                <div class="col-sm-6">
                                    <div class="w-100 label-input-field">
                                        <label>{{ localize('State') }}</label>
                                        <select class="select2Address" required name="state_id" id="edit_state_id">
                                            <option value="">{{ localize('Select State') }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="w-100 label-input-field">
                                        <label>{{ localize('City') }}</label>
                                        <select class="select2Address" required name="city_id" id="edit_city_id">
                                            <option value="">{{ localize('Select City') }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="w-100 label-input-field">
                                        <label>{{ localize('Area') }}</label>
                                        <select class="select2Address" required name="area_id" id="edit_area_id">
                                            <option value="">{{ localize('Select Area') }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="w-100 label-input-field">
                                        <label>{{ localize('Default Address?') }}</label>
                                        <select class="select2Address" name="is_default" id="edit_is_default">
                                            <option value="0">{{ localize('No') }}</option>
                                            <option value="1">{{ localize('Set Default') }}</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="label-input-field">
                                        <label>{{ localize('Address') }}</label>
                                        <textarea rows="4" placeholder="{{ localize('2/5 Elephant Road, New Town') }}" name="address" id="edit_address" required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-6 d-flex">
...
<script>
    ...
    function getAreas(city_id) {
        $.ajax({
            ...
            success: function(response) {
                $('[name="area_id"]').html("");
                $('[name="area_id"]').html(JSON.parse(response));
                addressModalSelect2(parent);
            }
        });
    }

    //  get delivery charges on area change
