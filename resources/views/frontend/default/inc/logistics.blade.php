{{-- filepath: c:\Users\jamsh\OneDrive\Pictures\uttam_kheti_production\resources\views\frontend\default\inc\logistics.blade.php --}}
<div style="display: none;">
    <h4 class="mt-7">{{ localize('Available Logistics') }}</h4>
    @forelse ($logisticZoneAreas as $index => $zoneArea)
                ...
                <div class="radio-left d-inline-flex align-items-center">
                    <div class="theme-radio">
                        <input type="radio" name="chosen_logistic_zone_id" id="logistic-{{ $zoneArea->logistic_zone_id }}"
                            value="{{ $zoneArea->logistic_zone_id }}" {{ $loop->first ? 'checked' : '' }}>
