<header class="gheader position-relative z-2 header-sticky bg-white">
    @php
        $bgClass = 'bg-primary';
        if (getTheme() == 'halal') {
            ...
            <div class="row align-items-center bg-white">
                ...
                <div class="col-md-3 col-12">
                    <div class='nav-menu-logo-container'>
                        ...
                        <button class="gshop-offcanvas-btn offcanvas-toggle ms-3 menu-btn">
                                ...
                                @if (getSetting('show_theme_changes') != 0 || (getSetting('show_theme_changes') == null && $theme_count > 1))
                                    ...
                                    @php
                                        ...
                                        if (getSetting('active_themes') != null) {
                                            $activeThemes = \App\Models\Theme::whereIn(
                                                'id',
                                                json_decode(getSetting('active_themes')),
                                            )->get();
                                        }
                                    @endphp
