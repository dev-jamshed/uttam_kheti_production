...
use App\Http\Controllers\Backend\Logistics\AreasController;
...
Route::group(
    ...
    function () {
        ...
        Route::group(['prefix' => 'logistics'], function () {
            ...
            Route::post('/logistic-zones/get-city-areas', [LogisticZonesController::class, 'getCityAreas'])->name('admin.logisticZones.getCityAreas');
            ...
            Route::get('/add-area', [AreasController::class, 'create'])->name('admin.areas.create');
            Route::post('/add-area', [AreasController::class, 'store'])->name('admin.areas.store');
            Route::get('/update-area/{id}', [AreasController::class, 'edit'])->name('admin.areas.edit');
            Route::post('/update-area', [AreasController::class, 'update'])->name('admin.areas.update');
            Route::post('/update-area-status', [AreasController::class, 'updateStatus'])->name('admin.areas.updateStatus');
        });
